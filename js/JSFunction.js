...
function loaddetailpage(textx,detailNO,NO) {
    ...
    $("#"+detailNO+"_ProductRadarUser").append( " <div id='ProductRadarUser' class='RadarSize'></div>"+
        " <script type='text/javascript'>"+
        " UserRadarlarge(83,'ProductRadarUser','"+obj.ProductsList[NO].ProductName+"',"+obj.ProductsList[NO].U1+","+obj.ProductsList[NO].U2+","+obj.ProductsList[NO].U3+","+obj.ProductsList[NO].U4+","+") </script>")
}
$(document).ready(function(){
